...
// Validating the user's date format to ensure no tampering
export function validateDateFormat(evt, dateFormatError) {
...
// Validating the user's time zone to ensure no tampering
export function validateTimeZone(evt, timeZoneError) {
